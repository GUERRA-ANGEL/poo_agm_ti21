...
radio = diametro / 2  #el radio es igual al diametro entre dos
area = PI * radio **2  #el area se saca Pi por radio al cuadrado
perimetro = 2 * PI * radio #el perimetro se saca dos por PI por radio
